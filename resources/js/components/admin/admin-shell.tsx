...
export function AdminShell({ children }: AdminShellProps) {
    return (
        <div className="relative min-h-screen overflow-hidden bg-herbal-100 text-herbal-950">
            ...
            />
            <div aria-hidden="true" className="pointer-events-none absolute -left-24 top-24 size-80 rounded-full bg-kunyit-100/30 blur-3xl" />
            <div aria-hidden="true" className="pointer-events-none absolute right-0 bottom-0 size-96 rounded-full bg-gojamu-100/40 blur-3xl" />
