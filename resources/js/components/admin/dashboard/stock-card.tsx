    ...
    return (
        <Card className="p-5">
            ...
            <CardDescription className="mt-1">
                Ringkas, padat, dan cukup buat lihat kondisi gudang sekilas.
            </CardDescription>
                ...
                {items.map((item) => (
                    <li key={item.name}>
                        <div className="flex items-center justify-between gap-4 text-sm">
                            <span className="font-bold text-herbal-700">
                                {item.name}
                            </span>
                            <span className="text-herbal-500">
                                {item.stock}
                            </span>
                        </div>
                        <div
