        ...
        <AdminLayout title="Order Reseller" eyebrow="Order Core">
            ...
            <section className="rounded-3xl border border-gojamu-100 bg-white p-5 shadow-sm shadow-gojamu-100">
                ...
                <p className="text-herbal-600 mt-2 text-sm">
                    Pantau invoice yang dibuat reseller sebelum masuk proses
                                ...
                                >
                                    <td className="px-5 py-4 font-black text-gojamu-950">
                                        <Link
                                            ...
                                            className="hover:text-gojamu-700"
                                        >
                                    ...
                                    <td className="px-5 py-4">
                                        <span className="text-kunyit-800 rounded-full bg-kunyit-50 px-3 py-1 text-xs font-bold">
                                            {order.status_label}
                                        </span>
                                    </td>
                                </tr>
