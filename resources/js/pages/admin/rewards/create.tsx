...
export default function AdminRewardsCreate() {
    const { data, setData, post, processing, errors } =
        useForm<CreateRewardForm>({
            name: '',
            description: '',
            required_points: '',
            stock: '',
    ...
    return (
        <AdminLayout title="Tambah Reward" eyebrow="Master Data">
            ...
            <section className="rounded-3xl border border-gojamu-100 bg-white p-5 shadow-sm shadow-gojamu-100">
                ...
                <p className="text-herbal-600 mt-2 text-sm">
                    Buat reward poin baru yang bisa ditukarkan oleh reseller.
                </p>
            </section>
